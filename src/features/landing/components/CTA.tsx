  ...
  return (
    <section className="pb-24 sm:pb-32">
      <div className="container">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl border border-primary/20 px-6 py-16 text-center shadow-elevated sm:px-16">
            <div className="aurora aurora-animate absolute inset-0 -z-10 opacity-90" />
            <div className="grain absolute inset-0 -z-10 opacity-[0.15] mix-blend-overlay" />
